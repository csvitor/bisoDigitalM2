...
class ImportMagentoProductsCron extends Command
{
    ...
    public function handle()
    {
        ...
        $params = [
            ...
            'fields' => 'items[id,sku,name,price,status,type_id,attribute_set_id,weight,visibility,updated_at,created_at,extension_attributes[category_links],custom_attributes[cost,url_key,sync_biso_digital,image,small_image,thumbnail,brand]],search_criteria[page_size,current_page],total_count[]',
            'searchCriteria' => [
                'filter_groups' => [
                    [
                        'filters' => [
